...
###4a. Get occurrence data ready and generate background points
...
xm <- maxent(x = predictors.cfp, 
               ...
               args = c("randomtestpoints=25"), #use 25% of data for test
               path = "data/output/083020_noreps")
plot(xm)
response(xm)
```
...
for (i in 1:5) {
  ...
  mx_e <- maxent(x = predictors.cfp,
                 p = as.matrix(train_p), 
                 a = as.matrix(train_b),
                 path = paste("data/output/083020_noreps/",i, sep = "")) 
